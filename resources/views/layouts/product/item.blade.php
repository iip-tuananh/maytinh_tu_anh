...
<article class="list-product">
   ...
   <div class="img-block">
      ...
      <img class="second-img" src="{{count($img) > 1 ?  $img[1] : $img[0]}}" alt="{{$pro->slug}}" />
      </a>
   </div>
   @if ($pro->discount > 0)
   ...
   <div class="add-to-link">
      <ul>
         <li class="cart">
            ...
            <a class="cart-btn" href="{{route('detailProduct',['cate'=>$pro->cate_slug,'type'=>$pro->type_slug ? $pro->type_slug : 'loai','id'=>$pro->slug])}}" onclick="addToCart({{$pro->id}},1)">Mua Ngay</a
               ></li>
      </ul>
   </div>
</article>